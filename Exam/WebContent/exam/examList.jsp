...
<div class="data_list">
	...
	<div class="search_content">
		<form action="${pageContext.request.contextPath}/exam!examList"
			method="post">
			<table align="center">
				<tr>
					<td><label>准考证号：</label></td>
					<td><input type="text" id="s_id" name="s_exam.student.id"
						value="${s_exam.student.id }" /></td>
					<td>&nbsp;</td>
					<td><label>姓名：</label></td>
					<td><input type="text" id="s_name" name="s_exam.student.name"
						value="${s_exam.student.name }" /></td>
					<td>&nbsp;</td>
